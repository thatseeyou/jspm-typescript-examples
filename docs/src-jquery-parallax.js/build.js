"bundle";
System.registerDynamic("src-jquery-parallax.js/css/styles.css!github:systemjs/plugin-css@0.1.36.js", [], false, function ($__require, $__exports, $__module) {
...
System.registerDynamic("npm:jquery-parallax.js@1.5.0/parallax.min.js", [], true, function ($__require, exports, module) {
  /* */
  "format cjs";
  /*!
  ...
  !function (t, i, e, s) {
    function o(i, e) {
      ...
      for (var t = 0, e = ["ms", "moz", "webkit", "o"], s = 0; s < e.length && !i.requestAnimationFrame; ++s) i.requestAnimationFrame = i[e[s] + "RequestAnimationFrame"], i.cancelAnimationFrame = i[e[s] + "CancelAnimationFrame"] || i[e[s] + "CancelRequestAnimationFrame"];i.requestAnimationFrame || (i.requestAnimationFrame = function (e) {
        ...
        var s,
            h = t(e).data("px.parallax");for (h.$mirror.remove(), s = 0; s < this.sliders.length; s += 1) this.sliders[s] == h && this.sliders.splice(s, 1);t(e).data("px.parallax", !1), 0 === this.sliders.length && (t(i).off("scroll.px.parallax resize.px.parallax load.px.parallax"), this.isReady = !1, o.isSetup = !1);
...
System.registerDynamic("npm:jquery-parallax.js@1.5.0.js", ["npm:jquery-parallax.js@1.5.0/parallax.min.js"], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  module.exports = $__require("npm:jquery-parallax.js@1.5.0/parallax.min.js");
});
System.registerDynamic("src-jquery-parallax.js/app/main.js", ["src-jquery-parallax.js/css/styles.css!github:systemjs/plugin-css@0.1.36.js", "npm:jquery@2.2.4.js", "npm:jquery-parallax.js@1.5.0.js"], true, function ($__require, exports, module) {
    "use strict";

    var global = this || self,
        GLOBAL = global;
    Object.defineProperty(exports, "__esModule", { value: true });
    $__require("src-jquery-parallax.js/css/styles.css!github:systemjs/plugin-css@0.1.36.js");
    var $ = $__require("npm:jquery@2.2.4.js");
    $__require("npm:jquery-parallax.js@1.5.0.js");
    $(function () {
